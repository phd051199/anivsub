...
import 'package:anivsub/data/repositories/home_repository_impl.dart' as _i723;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i174.GetIt init({
    ...
    gh.lazySingleton<_i772.HomeRepository>(
        () => _i723.HomeRepositoryImpl(gh<_i987.ScrapingClient>()));
    ...
    gh.factory<_i68.GetHomeDataUseCase>(
        () => _i68.GetHomeDataUseCase(gh<_i772.HomeRepository>()));
